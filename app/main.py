...
from app.routes.clippings import router as clippings_router
...
async def home(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request=request, name="index.html", context={"app_name": settings.app_name, "clients": clients, "error": error})

@app.get("/saude")
async def health() -> dict[str, str | bool]:
    return {"status": "ok", "produto": settings.app_name, "versao": "1.0.0", "banco_configurado": settings.database_configured}
